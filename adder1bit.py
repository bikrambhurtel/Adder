...
if __name__ == '__main__':
	while True:
		num1 = input("Enter first number(0 or 1): ")
		num2 = input("Enter second number(0 or 1): ")
		try:
			...
			if (num1 <= 1 and num2 <= 1) and (num1 >= 0 and num2 >= 0):
				calculation1bit(num1, num2)
			else:
				print('Expected value either 0 or 1. But {} and {} was given.'.format(num1, num2))
		
		except (ValueError, AttributeError):
			print('Expected integer value either 0 or 1. But {} and {} was given.'.format(num1, num2))
